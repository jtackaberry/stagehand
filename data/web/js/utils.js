...
(function() {
  ...
  this.Stagehand = (function() {
    ...
    Stagehand.prototype.bind = function(ntype, f) {
      var _base, _ref;
      if ((_ref = (_base = this.handlers)[ntype]) == null) {
        _base[ntype] = [];
      }
    ...
    Stagehand.prototype.handle_response = function(_arg) {
      var dfd, f, job, jobs, key, n, notifications, value, xhr, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _results;
      ...
      for (_j = 0, _len1 = notifications.length; _j < _len1; _j++) {
        ...
        if (n._ntype === 'alert') {
          if ((_ref2 = n.type) == null) {
            n.type = 'notice';
          }
          if ((_ref3 = n.nonblock) == null) {
            n.nonblock = false;
          }
          if ((_ref4 = n.animation) == null) {
            n.animation = 'fade';
          }
          if ((_ref5 = n.closer) == null) {
            n.closer = true;
          }
          if ((_ref6 = n.delay) == null) {
            n.delay = 8000;
          }
          for (key in n) {
            value = n[key];
        ...
        _results.push(self._load_config());
      }
      return _results;
    };
